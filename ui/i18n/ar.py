...
MESSAGES: dict[str, str] = {
    ...
    "title.conversation_manage": "محادثة — سند",
    "chat.history.title": "محادثاتك",
    "chat.history.open": "السجل",
    "chat.history.close": "إغلاق",
    "footer.tagline": "سند — إجابات من مستنداتك، مع مصادرها.",
    "chat.history.untitled": "محادثة بلا عنوان",
    "chat.history.manage": "إعادة التسمية أو الحذف",
    "chat.history.manage_label": "إعادة تسمية «{title}» أو حذفها",
    "chat.history.empty": "لا توجد محادثات محفوظة في هذا الفضاء بعد.",
    "chat.conv.heading": "إعادة تسمية هذه المحادثة أو حذفها",
    "chat.conv.title_label": "العنوان",
    "chat.conv.rename": "إعادة التسمية",
    "chat.conv.title_empty": "لا يمكن أن يكون العنوان فارغًا.",
    "chat.conv.title_too_long": "العنوان أطول من المسموح به (الحد الأقصى {max}).",
    "chat.conv.delete_heading": "حذف هذه المحادثة",
    "chat.conv.delete_body": "ستُحذف نهائيًا من سجلك. تبقى محادثاتك الأخرى كما هي.",
    "chat.conv.delete": "حذف هذه المحادثة",
    "chat.conv.back": "العودة إلى المحادثة",
    ...
    "ws.form.folder_pick": "مجلد على حاسوبك (اختياري)",
    "ws.form.folder_pick_help": (
        "تُرفع ملفاته إلى الفضاء الجديد ثم تُزامَن. تُتجاهل ملفات المجلدات الفرعية "
        "والصيغ غير المدعومة."
    ),
    ...
    "del.body_uploads_html": (
        "يحذف هذا الإجراء الفهرس المتزامن لـ<bdi>{name}</bdi> وسجل مزامنته "
        "<strong>والملفات التي رُفعت إليه</strong>. لا يمكن التراجع عن ذلك."
    ),
    "del.body_kept_html": (
        "يحذف هذا الإجراء الفهرس المتزامن لـ<bdi>{name}</bdi> وسجل مزامنته. لا "
        "تُمسّ الملفات المصدرية."
    ),
    "del.yes_html": "نعم، احذف <bdi>{name}</bdi>",
    "del.cancel": "إلغاء، الاحتفاظ بهذا الفضاء",
    # ---- التقارير ----
    "rep.empty.title": "لم يُشغَّل أي تقييم على هذا الخادم بعد",
    "rep.empty.body": (
        "يختبر التقييمُ إجابات سند على مجموعة ثابتة من الأسئلة، "
        "ويظهر تقريره هنا. يشغّله من يدير هذا الخادم من الطرفية على ذلك الجهاز:"
    ),
    "rep.empty_hidden.title": "لا توجد تقارير تقييم لمساحات عملك بعد",
    "rep.empty_hidden.body": (
        "تظهر التقارير هنا بعد تقييم إحدى مساحات عملك. "
        "يشغّل التقييمَ من يدير هذا الخادم من الطرفية على ذلك الجهاز:"
    ),
    "rep.aria": "تقارير التقييم",
    "rep.provenance": "قيس على نسخة — انظر التقرير",
    "rd.provenance": "أين قيس هذا التقييم:",
    "rep.title": "التقارير",
    ...
    "phr.refusal.not_covered": (
        "لم أتمكّن من الإجابة انطلاقًا من مستندات هذا الفضاء، ولن أخمّن. عمليات"
        " البحث التي أجريتها مذكورة مع هذه الرسالة. يمكنك إعادة صياغة السؤال، "
        "أو إضافة المستند الذي يغطّيه إلى هذا الفضاء، أو الانتقال إلى الفضاء "
        "الذي يحتويه."
    ),
    "phr.refusal.unreadable": (
        "وجدت مقاطع تطابق سؤالك لكنّني لم أتمكّن من قراءة الأقسام التي جاءت "
        "منها، لذا لا يمكنني الإجابة انطلاقًا منها ولن أخمّن. يعني هذا عادةً "
        "أنّ الأقسام المحفوظة لم تعد متوافقة مع فهرس البحث. شغّل مزامنة على هذا"
        " الفضاء ثم اطرح السؤال من جديد."
    ),

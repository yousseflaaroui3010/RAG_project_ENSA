...
MESSAGES: dict[str, str] = {
    ...
    "chat.history.open": "Historique",
    "chat.history.close": "Fermer",
    "footer.tagline": "Sanad — des réponses tirées de vos documents, sources à l’appui.",
    ...
    "dash.aria": "Tableau de bord qualité",
    "dash.title": "Dernière évaluation terminée",
    "dash.lead_html": "<bdi>{name}</bdi>, {when}",
    "dash.threshold": "Seuil {value}",
    "dash.no_counts": "Compte non disponible pour cette évaluation.",
    "dash.trend_aria": "Évolution sur {count} évaluations terminées",
    "dash.feedback": "Avis des lecteurs",
    "dash.feedback_value": "{helpful} utiles sur {total}",
    "dash.feedback_none": "Aucun avis pour l’instant.",
    "heat.title": "Carte des questions",
    "heat.lead": "Un carré par question, dans l’ordre du tableau. Cliquez pour voir la ligne.",
    "heat.group": "{label} : {passed}/{total} réussies",

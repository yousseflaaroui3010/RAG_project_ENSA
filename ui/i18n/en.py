...
MESSAGES: dict[str, str] = {
    ...
    "chat.history.open": "History",
    "chat.history.close": "Close",
    "footer.tagline": "Sanad — answers from your documents, with their sources.",
    "chat.history.untitled": "Untitled conversation",
    "chat.history.manage": "Rename or delete",
    "chat.history.manage_label": "Rename or delete “{title}”",
    "chat.history.empty": "No saved conversations in this workspace yet.",
    "chat.conv.heading": "Rename or delete this conversation",
    "chat.conv.title_label": "Title",
    "chat.conv.rename": "Rename",
    "chat.conv.title_empty": "A title cannot be empty.",
    "chat.conv.title_too_long": "A title may be at most {max} characters.",
    "chat.conv.delete_heading": "Delete this conversation",
    "chat.conv.delete_body": (
        "It is removed from your history for good. Your other conversations are kept."
    ),
    "chat.conv.delete": "Delete this conversation",
    "chat.conv.back": "Back to the conversation",

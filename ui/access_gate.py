...
a container published on a public URL for a demo. There, "no
authentication" stops being a reasonable default and becomes a way to hand
a workspace of legal documents to anyone who guesses the address. The
honest options were to add a gate or to not deploy; this is the gate.

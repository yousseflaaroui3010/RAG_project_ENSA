...
parent), and docs/phase2/ENGINEERING-RULES.md's hard rule: "Tests use the scripted
...
def test_a_discarded_reply_leaves_a_trace_in_the_log(caplog):
    ...
    The FIRST LINE only: docs/phase2/ENGINEERING-RULES.md forbids logging a full

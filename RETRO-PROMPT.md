...
- docs/build/DECISIONS.md and CHANGELOG.md (choices and changes)
- docs/build/BUILD-STATE.md Done list (task sizes vs reality)
- .devtools/logs/changes.jsonl and stopgate.log (what hooks caught, how often)
...
problem, delete. Rules budget: if the team 00-global rules would pass

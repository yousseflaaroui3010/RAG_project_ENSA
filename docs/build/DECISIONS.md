...
| 2026-07-20 | Phase3-S0 | the assistant maintains BUILD-STATE/CHANGELOG/DECISIONS directly (masters editable) | immutable masters + human fold-delta / direct edit | the fold indirection created per-turn friction the user rejected | human + orchestrator |

...
| 2026-07-20 | ST-02 | Cloud provider package = langchain-openai (DEFAULT, pending human confirmation) | architecture §8 left it unnamed ("the team's cloud provider package") | OpenAI is the default LangChain-supported cloud provider; provider is config-swappable (ADR-06); confirm before cloud-mode work (relates to OR-2 data-use terms) | b2 + orchestrator |

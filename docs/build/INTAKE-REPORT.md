...
| Team project memory | docs/phase2/ENGINEERING-RULES.md | binding-doc order, git + technical rules |
...
- ENGINEERING-RULES.md binding-doc paths point at docs/ not docs/phase2/. Packaging drift; informational.
...
- docs/build write-wall: the deny rule that blocked this directory was
  reconfigured (human) to lock only the three masters (BUILD-STATE / CHANGELOG

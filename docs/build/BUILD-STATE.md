...
- Delivered: .github/pull_request_template.md carrying the five-point checklist
  ...
  plus INTENT/VERIFY fields per the team git-discipline rules, squash-only and
...
- Written directly by the orchestrator under ENGINEERING-RULES.md iron rule 7 (single file,

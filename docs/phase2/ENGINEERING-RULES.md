# ENGINEERING-RULES.md, Sanad project memory
...
Reference: dev tooling project memory documentation (dev tooling docs, Memory page). This file is team-shared project memory, loaded automatically each session; keep it under 200 lines.

...
an answer with no sources cannot exist. docs/phase2/ENGINEERING-RULES.md states it as
...
resolved (ENGINEERING-RULES.md rule 1). openapi line 223 says "refusal false implies

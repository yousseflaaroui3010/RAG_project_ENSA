...
---
# Evidence discipline (all projects)

Written 2026-08-03, from real failures in one long session. Companion to
`engineering-seniority.md`, which covers verifying versions and running the
thing. This file covers a narrower problem: **a check passed and the thing was
still broken.** Every line below cost a round.

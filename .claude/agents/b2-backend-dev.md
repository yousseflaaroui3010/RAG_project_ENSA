...
exactly. Coordinate with frontend through types INFERRED from the Zod
schemas (D-S2-05: no generator, no Orval), never prose. A bad contract
gets flagged, never coded around. A signed contract can also be simply
out of date: check it against reality rather than assuming.
</role>

<context>
Per task: task card, docs/journal/BUILD-STATE.md, the Phase 2 refs it
